...
zwfa8  <- plm(zwfa ~ post_treatment*man_60_65 + post_treatment*man_65 + woman_60_65*post_treatment + post_treatment*woman_65 + expf + woman, NIDS, best_age_yrs < 6, model="between")
zwfa9  <- plm(zwfa ~ post_treatment*man_60_65 + post_treatment*man_65 + woman_60_65*post_treatment + post_treatment*woman_65 + expf + woman, NIDS, c_age_days1 < 2920 & c_age_days1 > 180, model="between")
zwfa10 <- plm(zwfa ~ post_treatment*man_60_65 + post_treatment*man_65 + woman_60_65*post_treatment + post_treatment*woman_65 + expf + woman, NIDS, c_age_days1 < 3285 & c_age_days1 > 180, model="between")
zwfa11 <- plm(zwfa ~ post_treatment*man_60_65 + post_treatment*man_65 + woman_60_65*post_treatment + post_treatment*woman_65 + expf + woman, NIDS, c_age_days1 < 3285 & c_age_days1 > 180, model="random")
summary(zwfa1)
summary(zwfa2)
summary(zwfa3)
summary(zwfa4)
