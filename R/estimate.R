...
zwfa9  <- plm(zwfa ~ post_treatment*man_60_65 + post_treatment*man_65 + woman_60_65*post_treatment + post_treatment*woman_65 + expf + woman, child, c_age_days1 < 2920 & c_age_days1 > 180, model="between")
zwfa10 <- plm(zwfa ~ post_treatment*man_60_65 + post_treatment*man_65 + woman_60_65*post_treatment + post_treatment*woman_65 + expf + woman, child, c_age_days1 < 3285 & c_age_days1 > 180, model="between")
zwfa11 <- plm(zwfa ~ post_treatment*man_60_65 + post_treatment*man_65 + woman_60_65*post_treatment + post_treatment*woman_65 + expf + woman, child, c_age_days1 < 3285 & c_age_days1 > 180, model="random")
summary(zwfa1)
summary(zwfa2)
summary(zwfa3)
summary(zwfa4)
...
# Food expenditure
expf1 <- plm(expf ~ post_treatment*man_60_65 + post_treatment*man_65 + woman_60_65*post_treatment + post_treatment*woman_65 + hhincome + woman, child, best_age_yrs < 6, model="random")
expf2 <- plm(expf ~ post_treatment*man_60_65 + post_treatment*man_65 + woman_60_65*post_treatment + post_treatment*woman_65 + hhincome + woman, child, model="random")
expf3 <- plm(expf ~ post_treatment*man_60_65 + man_65 + woman_60_65 + woman_65 + hhincome + woman, child, best_age_yrs < 6, model="random")
expf4 <- plm(expf ~ post_treatment*man_60_65 + man_65 + woman_60_65 + woman_65 + hhincome + woman, child, model="random")
summary(expf1)
summary(expf2)
summary(expf3)
summary(expf4)
