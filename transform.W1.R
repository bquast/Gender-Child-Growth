...
Child.W1$w1.c.popgrp.c <- ifelse(w1.c.popgrp <= 0, w1.c.popgrp, NA)
Child.W1$w1.c.popgrp <- ifelse(w1.c.popgrp >= 0, w1.c.popgrp, NA)
Child.W1$w1.c.slpm.c <- ifelse(w1.c.slpm <= 0, w1.c.slpm, NA)
Child.W1$w1.c.slpm <- ifelse(w1.c.slpm >= 0, w1.c.slpm, NA)
Child.W1$w1.c.hlthdes .c <- ifelse(w1.c.hlthdes  <= 0, w1.c.hlthdes , NA)
Child.W1$w1.c.hlthdes  <- ifelse(w1.c.hlthdes  >= 0, w1.c.hlthdes , NA)
Child.W1$w1.c.brwghtg.c <- ifelse(w1.c.brwghtg <= 0, w1.c.brwghtg, NA)
Child.W1$w1.c.brwghtg <- ifelse(w1.c.brwghtg >= 0, w1.c.brwghtg, NA)
Child.W1$w1.c.hlser.c <- ifelse(w1.c.hlser <= 0, w1.c.hlser, NA)
Child.W1$w1.c.hlser <- ifelse(w1.c.hlser >= 0, w1.c.hlser, NA)
Child.W1$w1.c.hlserbrn .c <- ifelse(w1.c.hlserbrn  <= 0, w1.c.hlserbrn , NA)
Child.W1$w1.c.hlserbrn  <- ifelse(w1.c.hlserbrn  >= 0, w1.c.hlserbrn , NA)
Child.W1$ w1.c.hlill30.c <- ifelse( w1.c.hlill30 <= 0,  w1.c.hlill30, NA)
Child.W1$ w1.c.hlill30 <- ifelse( w1.c.hlill30 >= 0,  w1.c.hlill30, NA)
Child.W1$ w1.c.mthali.c <- ifelse( w1.c.mthali <= 0,  w1.c.mthali, NA)
Child.W1$ w1.c.mthali <- ifelse( w1.c.mthali >= 0,  w1.c.mthali, NA)
Child.W1$ w1.c.mthhh.c <- ifelse( w1.c.mthhh <= 0,  w1.c.mthhh, NA)
Child.W1$ w1.c.mthhh <- ifelse( w1.c.mthhh >= 0,  w1.c.mthhh, NA)
Child.W1$ w1.c.mthsch.c <- ifelse( w1.c.mthsch <= 0,  w1.c.mthsch, NA)
Child.W1$ w1.c.mthsch <- ifelse( w1.c.mthsch >= 0,  w1.c.mthsch, NA)
Child.W1$ w1.c.mthtrt.c <- ifelse( w1.c.mthtrt <= 0,  w1.c.mthtrt, NA)
Child.W1$ w1.c.mthtrt <- ifelse( w1.c.mthtrt >= 0,  w1.c.mthtrt, NA)
Child.W1$ w1.c.fthali.c <- ifelse( w1.c.fthali <= 0,  w1.c.fthali, NA)
Child.W1$ w1.c.fthali <- ifelse( w1.c.fthali >= 0,  w1.c.fthali, NA)
Child.W1$ w1.c.fthhh.c <- ifelse( w1.c.fthhh <= 0,  w1.c.fthhh, NA)
Child.W1$ w1.c.fthhh <- ifelse( w1.c.fthhh >= 0,  w1.c.fthhh, NA)
Child.W1$ w1.c.fthsch.c <- ifelse( w1.c.fthsch <= 0,  w1.c.fthsch, NA)
Child.W1$ w1.c.fthsch <- ifelse( w1.c.fthsch >= 0,  w1.c.fthsch, NA)
Child.W1$ w1.c.fthtrt .c <- ifelse( w1.c.fthtrt  <= 0,  w1.c.fthtrt , NA)
Child.W1$ w1.c.fthtrt  <- ifelse( w1.c.fthtrt  >= 0,  w1.c.fthtrt , NA)
Child.W1$ w1.c.grcur.c <- ifelse( w1.c.grcur <= 0,  w1.c.grcur, NA)
Child.W1$ w1.c.grcur <- ifelse( w1.c.grcur >= 0,  w1.c.grcur, NA)
detach(Child.W1)
